...
<div style="padding-left: 50px;" >
  <h2 style="background-color: #D3C2D2; width: 1350px;padding-left: 120px;letter-spacing: 2px; font-size: 35px;  ">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="text-align: center;"> Humbang Hasundutan</strong><br><br>  Kabupaten Humbang Hasundutan adalah sebuah kabupaten di<br> Sumatra Utara, Indonesia. Dibentuk pada 28 Juli 2003,<br> kabupaten ini mempunyai luas sebesar 2.335,33 km² dan<br> beribu kotakan Dolok Sanggul. Kondisi fisik kabupaten ini<br> berada pada ketinggian 330-2.075 meter dpl. Menurut data<br> tahun Sensus Penduduk 2010 penduduknya berjumlah 171.650 <br>jiwa.<br><br>
  </h2>
</div>
          ...
          <div class="row" style="padding-left: 50px;padding-right: 50px;">
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="#" id="image_div">
                  <img src="image/humbahas/destinasi.jpg" style="width: 450px;height: 500px;">
            ...
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="#" id="image_div">
                  <img src="image/humbahas/transportasi.jpg" style="width: 450px;height: 500px;">
            ...
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="#" id="image_div">
                  <img src="image/humbahas/penginapan.jpg" style="width: 450px;height: 500px;">
            ...
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="#" id="image_div">
                  <img src="image/humbahas/oleholeh.jpg" style="width: 450px;height: 500px;">
            ...
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="" id="image_div">
                  <img src="image/humbahas/kuliner.jpg" style="width: 450px;height: 500px;">
            ...
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="#" id="image_div">
                  <img src="image/humbahas/umum.jpg" style="width: 450px;height: 500px;">
