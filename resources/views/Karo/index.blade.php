...
<div style="padding-left: 50px;" >
  <h2 style="background-color: #D3C2D2; width: 1350px;padding-left: 120px;letter-spacing: 2px; font-size: 35px;  ">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="text-align: center;"> Karo</strong><br><br>  Di dataran tinggi Karo ini bisa ditemukan indahnya nuansa<br> alam pegunungan dengan udara yang sejuk dan berciri khas<br> daerah buah dan sayur. Di daerah ini juga bisa kita nikmati <br>keindahan Gunung berapi Sibayak yang masih aktif dan<br> berlokasi di atas ketinggian 2.172 meter dari permukaan laut.<br> Arti kata Sibayak adalah Raja.<br><br>
  </h2>
</div>
          ...
          <div class="row" style="padding-left: 50px;padding-right: 50px;">
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="#" id="image_div">
                  <img src="image/karo/destinasi.jpg" style="width: 450px;height: 500px;">
            ...
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="#" id="image_div">
                  <img src="image/karo/transportasi.jpg" style="width: 450px;height: 500px;">
            ...
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="#" id="image_div">
                  <img src="image/karo/penginapan.jpg" style="width: 450px;height: 500px;">
            ...
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="#" id="image_div">
                  <img src="image/karo/oleholeh.jpg" style="width: 450px;height: 500px;">
            ...
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="" id="image_div">
                  <img src="image/karo/kuliner.jpg" style="width: 450px;height: 500px;">
            ...
            <div class="col-lg-4">
              <div class="card mb-4 box-shadow">
                <a href="#" id="image_div">
                  <img src="image/karo/umum.jpg" style="width: 450px;height: 500px;">
