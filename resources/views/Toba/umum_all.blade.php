		...
		<div class="row" > 
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow" style="border: none;">
                <a href="{{url('/hkbpbalige')}}">
                  <img src="image/tobasa/hkbpbalige.jpg" style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px;padding-left: 200px;">HKBP Balige</span></p>
                </a>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;">
                <a href="{{url('/bankbri')}}" >
                  <img src="image/tobasa/bankbri.jpg"  style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px;padding-left: 250px;">Bank BRI</span></p>
                </a>
              </div>
            </div>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;" >
                <a href="{{url('/posbalige')}}">
                  <img src="image/tobasa/posbalige.jpg"  style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px; padding-left: 230px;">Kantor POS Balige</span></p>
                </a>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    </div>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;">
                <a href="{{url('/polsekbalige')}}">
                  <img src="image/tobasa/polsek.jpg"  style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px; padding-left: 200px;">Polsek Balige</span></p>
                </a>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    </div>
