		...
		<div class="row" > 
			...
			<h1 style="text-align: center;padding-top: 20px;">
				...
				<div style="text-align: center;">
					...
					<a href="{{url('/destinasi_budaya')}}"><button style="height: 30px; width: 90px;color: black;background-color: #A05968">SEJARAH</button></a>
				</div>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;">
                <a href="#" >
                  <img src="image/tobasa/simalungun.jpg"  style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px;padding-left: 250px;">Simalungun</span></p>
                </a>
              </div>
            </div>
