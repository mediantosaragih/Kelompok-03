		...
		<div class="row" > 
			...
			<h1 style="text-align: center;padding-top: 20px;">
				...
				<div style="text-align: center;">
					<a href="{{url('/penginapan_all')}}"><button  style="height: 30px; width: 90px; color: black;">ALL</button></a>
					<a href="{{url('/penginapan_hotel')}}"><button style="height: 30px; width: 90px;">Hotel</button></a>
					<a href="{{url('/penginapan_homestay')}}"><button style="height: 30px; width: 90px;background-color: #A05968; color: black;color: black;">HomeStay</button></a>
				</div>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow" style="border: none;">
                <a href="museum_tb.html">
                  <img src="image/tobasa/samiangel.jpg" style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px;padding-left: 200px;">Samiangel</span></p>
                </a>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;">
                <a href="#" >
                  <img src="image/tobasa/mikha.jpg"  style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px;padding-left: 250px;">Mikha</span></p>
                </a>
              </div>
            </div>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;" >
                <a href="#">
                  <img src="image/tobasa/ita.jpg"  style="width: 100%;height: 300px;">
                  <p id="image_label" style="background-color: #A05968;height: 35px; width: 100%; padding-bottom: -20px;" ><span style="color: white; font-size: 18px; padding-left: 230px;">Ita</span></p>
                </a>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    </div>
