		...
		<div class="row" > 
			...
			<h1 style="text-align: center;padding-top: 20px;">
				...
				<div style="text-align: center;">
					<a href="{{url('/umum_all')}}"><button  style="height: 30px; width: 90px; color: black;">ALL</button></a>
					<a href="{{url('/umum_bank')}}"><button style="height: 30px; width: 90px;color: black;background-color: #A05968;">BANK</button></a>
