		...
		<div class="row" > 
			...
			<h1 style="text-align: center;padding-top: 20px;">
				...
				<div style="text-align: center;">
					<a href="{{url('/destinasi_all')}}"><button  style="height: 30px; width: 90px; ;color: black;">ALL</button></a>
					<a href="{{url('/destinasi_alam')}}"><button style="height: 30px; width: 90px;color: black;background-color: #A05968">ALAM</button></a>
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow" style="border: none;">
                <a href="museum_tb.html">
                  <img src="image/tobasa/sejuk_pas.jpg" style="width: 100%;height: 300px;">
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;">
                <a href="#" >
                  <img src="image/tobasa/katasa.jpg"  style="width: 100%;height: 300px;">
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;" >
                <a href="#">
                  <img src="image/tobasa/aek_manik.jpg"  style="width: 100%;height: 300px;">
            ...
            <div class="col-lg-6" style="top: 50px;">
              <div class="card mb-4 box-shadow"style="border: none;">
                <a href="#">
                  <img src="image/tobasa/kebun_teh.jpg" style="width: 100%;height: 300px;">
