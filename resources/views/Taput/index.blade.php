...
<div style="padding-left: 50px;" >
  <h2 style="background-color: #D3C2D2; width: 1350px;padding-left: 120px;letter-spacing: 2px; font-size: 35px;  ">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong style="text-align: center;"> Tapanuli Utara</strong><br><br>  Tapanuli Utara dengan ibu kotanya berada di Tarutung.<br> Penduduk Tapanuli Utara umumnya beragama Kristen<br> Protestan/Katolik (98.24 persen), Islam (1.7 persen), dan Buddha <br>(0.05 persen). Wilayah ini memiliki keindahan alam dengan<br> panorama, terutama Pulau Sibandang di kawasan Danau Toba<br> di Kecamatan Muara dan wisata rohani Salib Kasih.<br><br>
  </h2>
</div>
